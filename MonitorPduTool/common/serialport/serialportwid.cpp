...
void SerialPortWid::updateBaudRate(qint32 br)
{
    ui->baudComBox->setCurrentText(QString::number(br));
}
...
void SerialPortWid::updateBtnSlot()
{
    initSerialPort();
    statusSlot();
    MsgBox::information(this, tr("串口刷新成功"));
}
...
//        if(ret) {
//            MsgBox::information(this, tr("串口:%1回环测试成功").arg(mSerialPort->getSerialName()));
//        } else {
